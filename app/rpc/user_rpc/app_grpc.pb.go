...
type HelloClient interface {
	Info(ctx context.Context, in *HelloInfoReq, opts ...grpc.CallOption) (*HelloInfoResp, error)
}
...
func (c *helloClient) Info(ctx context.Context, in *HelloInfoReq, opts ...grpc.CallOption) (*HelloInfoResp, error) {
	out := new(HelloInfoResp)
	err := c.cc.Invoke(ctx, "/user_rpc.Hello/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServer interface {
	Info(context.Context, *HelloInfoReq) (*HelloInfoResp, error)
...
func (UnimplementedHelloServer) Info(context.Context, *HelloInfoReq) (*HelloInfoResp, error) {
...
func _Hello_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_rpc.Hello/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).Info(ctx, req.(*HelloInfoReq))
	}
